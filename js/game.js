...
const CUSTOMERS = [
  ...
  // 1 ── OVERCONFIDENT TEEN
  {
    ...
    rounds:[
      { customerLine:"Yeah so basically I need something fast. My friend Tyler has a WRX and I need to pull harder than a WRX. What have you got.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Flatter his taste",
            text:"\"Man, you walk in here knowing exactly what you want. I respect that. Tyler's gonna regret that WRX.\"",
            moodDelta:+15, statHint:{charm:+3},
            nextLine:"Right? Yeah. Okay so like, what's the fastest thing on this lot." },
          { tag:'honest', cls:'honest-btn', label:"Manage expectations",
            text:"\"I'm gonna be straight with you — nothing on this lot outruns a WRX. But we can make Tyler think it does.\"",
            moodDelta:+5, statHint:{honesty:+3},
            nextLine:"...Okay that's actually kind of genius. What are we working with." },
          { tag:'hustle', cls:'hustle-btn', label:"Invent a backstory",
            text:"\"You know, the Firebird we have? Previous owner was a track day instructor. 'Nuff said.\"",
            moodDelta:+10, statHint:{closing:+2},
            nextLine:"Wait seriously?? A track instructor?? Does it have mods??" },
          { tag:'wild',   cls:'wild-btn',   label:"Question his authority",
            text:"\"Does Tyler even know what a WRX IS or did he just like the color?\"",
            moodDelta:-5, statHint:{charm:+1},
            nextLine:"...He said it's Japanese. I think that means it's fast." },
        ]},
      { customerLine:"Okay so I'm looking at this Firebird. My budget is like... my dad said two thousand but I think I can push it if I tell him the insurance is cheaper.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Lock in the dream",
            text:"\"The Firebird is a statement. You don't buy a Firebird, Kevin. You BECOME a Firebird.\"",
            moodDelta:+18, statHint:{charm:+4},
            nextLine:"...I feel that. I genuinely feel that. How much is it." },
          { tag:'honest', cls:'honest-btn', label:"Warn him gently",
            text:"\"The Firebird's $2,600. And heads-up — V8s don't love young male insurance rates.\"",
            moodDelta:+8, statHint:{honesty:+4},
            nextLine:"Okay but like... it looks sick. My dad might have a card I don't know about." },
          { tag:'hustle', cls:'hustle-btn', label:"Suggest kid accounting",
            text:"\"Tell your dad the Corolla is $2,500 and bring the difference. Classic move.\"",
            moodDelta:+12, statHint:{closing:+4,honesty:-2},
            nextLine:"That's... kind of a lot of lying. I'm in." },
          { tag:'wild',   cls:'wild-btn',   label:"Offer him the Neon instead",
            text:"\"Kevin. Forget the Firebird. The Neon. One red door. Already iconic.\"",
            moodDelta:-10, statHint:{charm:+1},
            nextLine:"I am NOT pulling up in a Neon. Tyler would never let me live." },
        ]},
      { customerLine:"Alright, alright. I want the Firebird. Is there like... any wiggle room? My dad is literally texting me right now.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Make him feel chosen",
            text:"\"I like you Kevin. $2,400 — but only because you didn't walk in here asking about Kias.\"",
            moodDelta:+20, statHint:{charm:+5}, outcome:'sold', commission:480,
            nextLine:"YOOO. Okay. Yeah. My dad is gonna be so mad. I love it. Deal." },
          { tag:'honest', cls:'honest-btn', label:"Hold price, throw in gas",
            text:"\"Price is $2,600. But I'll throw in a full tank and a prayer for your insurance quote.\"",
            moodDelta:+10, statHint:{honesty:+5}, outcome:'sold', commission:520,
            nextLine:"Ha. Okay fine. Deal. Don't tell my dad about the gas." },
          { tag:'hustle', cls:'hustle-btn', label:"Create urgency",
            text:"\"Got a guy coming in tomorrow specifically asking about Firebirds. Just saying.\"",
            moodDelta:-5, statHint:{closing:+5,honesty:-3}, outcome:'walkout', commission:0,
            nextLine:"That's a lie. I literally watched you say that to the last guy. I'm going to look at Hondas." },
          { tag:'wild',   cls:'wild-btn',   label:"Offer to call his dad",
            ...
            nextLine:"I... he picked up and you said 'Sir your son has excellent taste' and then he hung up. I gotta go." },
        ]},
    ]
  },
  ...
  // 2 ── BARGAIN HUNTER
  {
    ...
    intro:"A woman strides in clutching a manila folder stuffed with printed-out Kelley Blue Book pages. She has done the math. She has done everyone else's math too.",
    rounds:[
      { customerLine:"I did my research. I know what these cars are worth. I printed the Kelley Blue Book values for all eight of your cars and I have notes.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Respect the preparation",
          ...
          { tag:'honest', cls:'honest-btn', label:"Welcome the transparency",
            ...
            nextLine:"Finally. Someone reasonable. The Corolla. KBB says eight-fifty for that condition." },
          { tag:'hustle', cls:'hustle-btn', label:"Challenge the data",
            text:"\"KBB doesn't account for regional demand. In this zip code, that Corolla has a waiting list.\"",
            moodDelta:-8, statHint:{closing:+2,honesty:-2},
            nextLine:"I checked Craigslist. There are six Corollas within ten miles. Sit down." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask to see the spreadsheet",
            ...
            nextLine:"...You know what, I appreciate that. The Neon column is highlighted red. Obvious reasons." },
        ]},
      { customerLine:"I want the Corolla. KBB private party value for this mileage is eight hundred and fifty. Your asking price is thirteen hundred. Explain the difference.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Sell the intangible",
            text:"\"The extra $450? That's the peace of mind of buying from someone who's seen this car in daylight.\"",
            moodDelta:+5, statHint:{charm:+3},
            nextLine:"That is the vaguest value proposition I have ever heard. I'm almost impressed." },
          { tag:'honest', cls:'honest-btn', label:"Give a real number",
            text:"\"Fair point. My cost of holding it, cleaning it, and paperwork is real. I can do $1,050.\"",
            moodDelta:+22, statHint:{honesty:+6},
            nextLine:"...$1,050. Okay. That I can work with. It better start on the first try." },
          { tag:'hustle', cls:'hustle-btn', label:"Bundle a phantom extra",
            text:"\"The $1,200 includes our 30-day lot guarantee. It's in the paperwork.\"",
            moodDelta:-12, statHint:{closing:+2,honesty:-4},
            nextLine:"Can I see the guarantee documentation. RIGHT now." },
          { tag:'wild',   cls:'wild-btn',   label:"Tell the Neon story",
            text:"\"The Neon is $650. One door's a different color. That door was touched by a man named Ronnie who believed in it.\"",
            moodDelta:-5, statHint:{charm:+1},
            nextLine:"I don't want the Neon. I came for the Corolla. Focus." },
        ]},
      { customerLine:"Alright. I'm prepared to write a check for $975. And before you say anything, I also have a coupon. It's from a Jiffy Lube but the concept applies.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Accept with grace",
            text:"\"Deb, I would be honored to take your Jiffy Lube coupon as a spiritual gesture. $975. Done.\"",
            moodDelta:+15, statHint:{charm:+5}, outcome:'lowball', commission:195,
            nextLine:"Ha. Good answer. You're not the worst. Don't tell the others." },
          { tag:'honest', cls:'honest-btn', label:"Counter at your floor",
            text:"\"$1,025. That's my honest floor. And I genuinely appreciate you knowing your stuff.\"",
            moodDelta:+10, statHint:{honesty:+6}, outcome:'sold', commission:340,
            nextLine:"...$1,025. Fine. The coupon stands as a moral victory, understood?" },
          { tag:'hustle', cls:'hustle-btn', label:"Hold firm at $1,200",
          ...
          { tag:'wild',   cls:'wild-btn',   label:"Honor the coupon literally",
            text:"\"You know what? $975 minus $3.50 off an oil change. That's $971.50. Done.\"",
            moodDelta:+25, statHint:{charm:+6,closing:+4}, outcome:'sold', commission:290,
            nextLine:"...I have waited my entire adult life for someone to honor one of my coupons. You have a customer for life. I have more coupons." },
        ]},
    ]
  },
  ...
  // 3 ── FIRST-TIME BUYER
  {
    ...
    rounds:[
      { customerLine:"Okay so, hi. I've never bought a car before. I've done a lot of research. Maybe too much research. Can I just — is this car going to explode?",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Calm him down warmly",
            text:"\"No explosions. Promise. Take a breath. You already did the hard part by showing up.\"",
            moodDelta:+18, statHint:{charm:+4},
            nextLine:"Okay. Okay good. The Reddit thread said to always check the — can I smell the engine?" },
          { tag:'honest', cls:'honest-btn', label:"Walk him through the basics",
            text:"\"None of these will explode. Corolla, Civic, Outback — all solid for a first car. I'll tell you what I actually know about each.\"",
          ...
          { tag:'hustle', cls:'hustle-btn', label:"Overwhelm with confidence",
            text:"\"You've done plenty of research. Now let experience take the wheel. Follow me.\"",
            moodDelta:-5, statHint:{closing:+2},
            nextLine:"I — wait I had a checklist. It has seventeen items. I printed it." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask how many tabs",
            text:"\"How many tabs do you have open right now. Honestly.\"",
            moodDelta:+8, statHint:{charm:+2},
            nextLine:"...Forty-seven. One of them is still loading. I think it's in Portuguese." },
        ]},
      { customerLine:"I think I want the Corolla. It has five stars on every safety rating I found. But I'm scared there's something wrong with it that I can't see.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Build trust gently",
            text:"\"The Corolla is genuinely the right call. If there was something hidden, I'd sell you the Explorer instead.\"",
            moodDelta:+15, statHint:{charm:+3},
            nextLine:"...That's actually a really reassuring thing to say. Wait, what's wrong with the Explorer?" },
          { tag:'honest', cls:'honest-btn', label:"Tell him the real condition",
            text:"\"High miles, paint's faded. But Corollas don't care. This one will outlive both of us.\"",
            moodDelta:+22, statHint:{honesty:+6},
            nextLine:"You're not supposed to say that right? That it has problems? I appreciate it. A lot." },
          { tag:'hustle', cls:'hustle-btn', label:"Redirect to the paperwork",
            text:"\"We run a full inspection report on every car. It's all documented. Nothing to worry about.\"",
            moodDelta:+5, statHint:{closing:+3,honesty:-2},
            nextLine:"Can I see the report? Like, the actual report?" },
          { tag:'wild',   cls:'wild-btn',   label:"Offer a test drive right now",
            text:"\"Stop thinking. Keys are in it. Let's go right now.\"",
            moodDelta:-8, statHint:{charm:+1},
            nextLine:"I — I haven't finished my checklist. Number seven is 'listen for clicking sounds' and I don't know what that means yet." },
        ]},
      { customerLine:"Okay. I want it. I've decided. $1,200 and I feel like I'm going to pass out a little bit.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Congratulate him sincerely",
            text:"\"That's the right car at the right price and you made a smart call. First car is a big deal. Congrats.\"",
            moodDelta:+20, statHint:{charm:+5}, outcome:'sold', commission:360,
            nextLine:"Oh wow. Thank you. I'm going to go sit in it for a minute if that's okay." },
          { tag:'honest', cls:'honest-btn', label:"Confirm and reassure",
            text:"\"$1,200, done. It's a good car Marcus. You did your homework and it paid off.\"",
            moodDelta:+18, statHint:{honesty:+5}, outcome:'sold', commission:360,
            nextLine:"Can I keep the Carfax printout? I want to frame it. Is that weird? That might be weird." },
          { tag:'hustle', cls:'hustle-btn', label:"Add on a warranty pitch",
            text:"\"Excellent. And for just $200 more I can add our lot protection package.\"",
            moodDelta:-15, statHint:{closing:+3,honesty:-3}, outcome:'walkout', commission:0,
            nextLine:"I...I need to go back and read more threads. This is too much. I'll come back. I might come back." },
          { tag:'wild',   cls:'wild-btn',   label:"Tell him to call his mom first",
            text:"\"Before you sign, call your mom. Not because you have to. Because you'll want to tell her.\"",
            moodDelta:+25, statHint:{charm:+6,honesty:+3}, outcome:'lowball', commission:240,
            nextLine:"...[long pause] She cried. Then asked if you got a deal. She said negotiate harder next time. $240 commission. Worth it." },
        ]},
    ]
  },
  ...
  // 4 ── STATUS CHASER
  {
    ...
    rounds:[
      { customerLine:"I'm looking for something with a narrative. Something I can talk about. My therapist says I attach meaning to objects. She's right, obviously.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Speak his language",
            text:"\"Every car on this lot has a story. The question is which one fits the chapter you're in.\"",
            moodDelta:+20, statHint:{charm:+5},
            nextLine:"Oh that's good. That's actually very good. What chapter do you think I'm in?" },
          { tag:'honest', cls:'honest-btn', label:"Redirect to actual cars",
            text:"\"With respect, the car just needs to run. The narrative is whatever you make of it.\"",
            moodDelta:-5, statHint:{honesty:+3},
            nextLine:"That's a very... utilitarian perspective. I'm not sure we're compatible." },
          { tag:'hustle', cls:'hustle-btn', label:"Pitch the BMW immediately",
            text:"\"I have a 1997 BMW 3 Series. Previous owner was in finance. Make of that what you will.\"",
            moodDelta:+15, statHint:{closing:+4},
            nextLine:"Finance. Interesting. Was it hedge funds or something more artisanal?" },
          { tag:'wild',   cls:'wild-btn',   label:"Ask what his therapist drives",
      ...
      { customerLine:"Tell me about the BMW. I know nothing about cars but I need to sound like I do at Geoff's dinner next Friday. Geoff has a Porsche, which is annoying.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Feed the dinner party story",
            text:"\"This particular 3 Series is a turning-point car. The last generation before BMW got complicated. Connoisseurs know.\"",
            moodDelta:+22, statHint:{charm:+5},
            nextLine:"'The last generation before it got complicated.' Say that again slowly. I'm memorizing it." },
          { tag:'honest', cls:'honest-btn', label:"Warn about the maintenance",
            text:"\"The BMW looks the part, but these '97s have real maintenance costs. You need to know that going in.\"",
            moodDelta:+8, statHint:{honesty:+6},
            nextLine:"How much are we talking. Ballpark." },
          { tag:'hustle', cls:'hustle-btn', label:"Name-drop some engineering",
            text:"\"Inline-six engine, rear-wheel drive, legendary handling. You'll feel it the moment you turn.\"",
            moodDelta:+12, statHint:{closing:+4},
            nextLine:"I don't know what any of that means but it sounded incredible. What's inline-six?" },
          { tag:'wild',   cls:'wild-btn',   label:"Suggest he out-class Geoff entirely",
            text:"\"Forget matching Geoff. The Firebird shows up to his dinner party like it doesn't care about dinner parties.\"",
            moodDelta:+10, statHint:{charm:+3},
            nextLine:"...A Firebird. That's insane. That's actually insane. Tell me more." },
        ]},
      { customerLine:"I'll take the BMW. $2,800. Is there anything else I should know? For the story, I mean.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Send him off with a line",
            text:"\"Tell Geoff you bought it from a guy who didn't ask questions. That's usually the best part.\"",
            moodDelta:+18, statHint:{charm:+5}, outcome:'sold', commission:560,
            nextLine:"Perfect. That's the whole thing right there. Geoff is going to hate this." },
          { tag:'honest', cls:'honest-btn', label:"Disclose one real thing",
            text:"\"The AC compressor runs a little loud. It's fine but worth knowing. Everything else is solid.\"",
            moodDelta:+12, statHint:{honesty:+5}, outcome:'sold', commission:560,
            nextLine:"I appreciate that. Genuinely. The AC thing will be my 'I know cars' moment." },
          { tag:'hustle', cls:'hustle-btn', label:"Upsell the detailing",
            text:"\"For $150 I'll have it detailed before Friday. Show up clean, show up right.\"",
            moodDelta:+10, statHint:{closing:+5}, outcome:'sold', commission:710,
            nextLine:"Yes. Absolutely yes. Geoff's Porsche always looks immaculate and I hate it." },
          { tag:'wild',   cls:'wild-btn',   label:"Give him a fake VIN story",
            text:"\"The previous owner left a book in the glovebox. A novel. In French. You're welcome.\"",
            moodDelta:+5, statHint:{charm:+2}, outcome:'lowball', commission:420,
            nextLine:"...Was there actually a book? I need there to have been a book. Preston out. [leaves immediately to check]" },
        ]},
    ]
  },
  ...
  // 5 ── OUTDOORSY TYPE
  {
    ...
    rounds:[
      { customerLine:"I need something I can get dirty. Not showroom dirty — actually dirty. I'm doing the Colorado Trail in September and I need to get the gear there.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Speak the outdoor code",
            text:"\"We don't wash the Outback between October and May. The dirt is proof of life. I think you'll get along.\"",
            moodDelta:+20, statHint:{charm:+5},
            nextLine:"Okay. Okay I like you. Show me the Outback." },
          { tag:'honest', cls:'honest-btn', label:"Give a straight recommendation",
            text:"\"The Outback is your car. All-wheel drive, decent clearance, Subaru reliability. It's done this trip before.\"",
            moodDelta:+18, statHint:{honesty:+5},
            nextLine:"The scratches on the quarter panel — those look like they're from a trail. Am I right?" },
          { tag:'hustle', cls:'hustle-btn', label:"Pitch the Silverado",
            text:"\"You want a truck. The Silverado hauls everything and goes anywhere. Colorado is nothing to it.\"",
            moodDelta:+8, statHint:{closing:+3},
            nextLine:"Trucks are a lot. I camp light. What's the clearance on the Outback?" },
          { tag:'wild',   cls:'wild-btn',   label:"Ask about the vest pockets",
            text:"\"How many pockets in that vest. I'm genuinely asking.\"",
            moodDelta:+10, statHint:{charm:+3},
            nextLine:"Eleven. Four are hidden. One has an emergency whistle I've never had to use but will." },
        ]},
      { customerLine:"The Outback looks right. What's the clearance on it? I'm going on roads that aren't really roads.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Lean into the mystique",
            text:"\"Those scratches on the side? Moab. The previous owner was... committed.\"",
            moodDelta:+15, statHint:{charm:+4},
            nextLine:"That is exactly the energy I'm looking for in a vehicle." },
          { tag:'honest', cls:'honest-btn', label:"Give real numbers",
            text:"\"About 8.7 inches of ground clearance stock. Not a Jeep, but handles gravel roads, fire roads, packed dirt fine.\"",
            moodDelta:+20, statHint:{honesty:+5},
            nextLine:"8.7 is enough for what I'm doing. And the AWD is real AWD, not just marketing?" },
          { tag:'hustle', cls:'hustle-btn', label:"Invent an offroad credential",
            text:"\"The previous owner did overlanding. I don't know if that means anything but he seemed serious.\"",
            moodDelta:+5, statHint:{closing:+2,honesty:-2},
            nextLine:"...Overlanding is just camping with better tires. But okay, I respect the spirit." },
          { tag:'wild',   cls:'wild-btn',   label:"Suggest they both test it on the dirt",
            text:"\"There's a fire road two miles up the highway. We can take it right now if you want the real answer.\"",
            moodDelta:+12, statHint:{charm:+3,honesty:+2},
            nextLine:"...Are you serious? Because I would absolutely do that. Do you have snacks?" },
        ]},
      { customerLine:"Alright, $2,200. Is that the number or is there room? I'm not rich, I just need the car to work.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Throw in trail advice",
            text:"\"$2,200 is the number. I'll also tell you which tire pressure works best on the Colorado Trail. I've done it.\"",
            moodDelta:+15, statHint:{charm:+5}, outcome:'sold', commission:440,
            nextLine:"Done. And I'm holding you to that tire pressure thing. That's real value." },
          { tag:'honest', cls:'honest-btn', label:"Hold firm with honesty",
            text:"\"$2,200 is fair for what it is. No games — it's a good car at an honest price.\"",
            moodDelta:+18, statHint:{honesty:+5}, outcome:'sold', commission:440,
            nextLine:"Yeah. I can tell you mean it. Done. Do you need a hug or is a handshake fine?" },
          { tag:'hustle', cls:'hustle-btn', label:"Create a deadline",
            text:"\"I've got someone else looking at the Outback this weekend. $2,200 holds until Friday.\"",
          ...
          { tag:'wild',   cls:'wild-btn',   label:"Offer a gear swap",
            text:"\"$2,100 if you leave me one of those vest pockets. Any pocket. Your choice.\"",
            moodDelta:+20, statHint:{charm:+6,closing:+3}, outcome:'lowball', commission:310,
            nextLine:"...[removes pocket square] Done. It's a hidden one. Also I'm taking $200 off for the novelty. Still a deal." },
        ]},
    ]
  },
  ...
  // 6 ── ALPHA MALE
  {
    ...
    intro:"Chad enters leading with his chest. He is wearing a shirt that says something in all caps. He has already decided he wants the fastest, biggest, loudest thing you have, and he wants it to know he's in charge.",
    rounds:[
      { customerLine:"What's your biggest engine. Don't show me sedans. Don't show me hybrids. I need something that sounds like it means business.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Match his energy",
            text:"\"V8 Firebird and a Silverado. Both sound like a tax problem. Follow me.\"",
            moodDelta:+20, statHint:{charm:+4},
            nextLine:"NOW we're talking. Which one's louder." },
          { tag:'honest', cls:'honest-btn', label:"Set expectations clearly",
            text:"\"The biggest we have is the Silverado V8 or the Firebird V8. Neither is new, but both will rattle your fillings.\"",
            moodDelta:+12, statHint:{honesty:+4},
            nextLine:"Fillings. Good. My dentist says I clench at night. This should fix that." },
          { tag:'hustle', cls:'hustle-btn', label:"Let him lead to the lot",
            text:"\"Pick a direction. Whichever one draws you, that's your car.\"",
            moodDelta:+8, statHint:{closing:+3},
            nextLine:"[walks directly to Firebird] Yeah. This. Obviously this." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask what his gym PR is",
            text:"\"Before we talk cars — what's your bench?\"",
            moodDelta:+15, statHint:{charm:+5},
            nextLine:"315. Raw. Why — does that matter for the car?" },
        ]},
      { customerLine:"The Firebird. How fast does it go. And don't give me city MPG, I don't care about city MPG.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Speak his truth",
            text:"\"Zero to sixty in under seven seconds stock. It's not a supercar. It's a statement. There's a difference.\"",
            moodDelta:+18, statHint:{charm:+5},
            nextLine:"A statement. Yes. That is exactly what I need to make. To Dave." },
          { tag:'honest', cls:'honest-btn', label:"Give real performance data",
            text:"\"5.7 liter V8, about 285 horsepower in this era. Quick for its age. The exhaust is genuinely great.\"",
            moodDelta:+15, statHint:{honesty:+4},
            nextLine:"285 horses. In 1995. That's respectable. Dave drives a Camry so this is fine." },
          { tag:'hustle', cls:'hustle-btn', label:"Suggest he feels it for himself",
            text:"\"Get in. Start it. The numbers don't matter once you hear that engine turn over.\"",
            moodDelta:+14, statHint:{closing:+5},
            nextLine:"[30 seconds later] Okay. Yeah. I need this. This is the one." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask who Dave is",
            text:"\"Who's Dave?\"",
            moodDelta:+10, statHint:{charm:+4},
            nextLine:"My coworker. He got a promotion last month and has been insufferable. This is about Dave." },
        ]},
      { customerLine:"$2,600. Is that firm? I feel like I should negotiate. That's what men do. I've been told that.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Respect the ritual",
            text:"\"$2,500. You negotiated, I moved. Everyone goes home with their dignity.\"",
            moodDelta:+18, statHint:{charm:+5}, outcome:'sold', commission:500,
            nextLine:"Perfect. That felt right. Dave is going to lose his mind." },
          { tag:'honest', cls:'honest-btn', label:"Tell him the price is fair",
            text:"\"$2,600 is already fair for a V8 that runs this clean. I'm not padding it. No room to move.\"",
            moodDelta:+10, statHint:{honesty:+5}, outcome:'sold', commission:520,
            nextLine:"Alright. I respect straight talk. $2,600. Done. Shake on it." },
          { tag:'hustle', cls:'hustle-btn', label:"Throw in a detail session",
            text:"\"$2,600 firm. But I'll have it waxed before you pick it up. Show up shiny for Dave.\"",
            moodDelta:+15, statHint:{closing:+5}, outcome:'lowball', commission:390,
            nextLine:"Waxed. Fine. But I'm getting $200 off. Dave situation is complicated and I need leverage." },
          { tag:'wild',   cls:'wild-btn',   label:"Challenge him to arm wrestle for it",
            text:"\"You win, $2,400. I win, $2,700. Best of one.\"",
            moodDelta:+5, statHint:{charm:+3}, outcome:'lowball', commission:480,
            nextLine:"[30 seconds later] I don't know how you did that. $2,400. You've earned it. I need to go to the gym." },
        ]},
    ]
  },
  ...
  // 7 ── KAREN
  {
    ...
    intro:"Brenda arrives already disappointed. She has not yet seen anything wrong, but she will. She came prepared with a list of questions and a look that suggests she has already spoken to several managers.",
    rounds:[
      { customerLine:"I need to speak to someone in charge. Are you in charge? Because the last place I went the person wasn't actually in charge and that was a whole situation.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Claim full authority",
            text:"\"I am completely in charge. Owner, operator, and chief decision maker. The buck stops here.\"",
            moodDelta:+18, statHint:{charm:+5},
            nextLine:"Good. Because I have questions and I need them answered by the right person." },
          { tag:'honest', cls:'honest-btn', label:"Be transparent",
            text:"\"It's my lot, yes. I'll answer what I can honestly and tell you if I don't know.\"",
            moodDelta:+10, statHint:{honesty:+4},
            nextLine:"...Fine. That's acceptable. Most places won't admit when they don't know things." },
          { tag:'hustle', cls:'hustle-btn', label:"Redirect immediately",
            ...
            moodDelta:+5, statHint:{closing:+2},
            nextLine:"I'll ask the questions here. My needs are specific and I have written them down." },
          { tag:'wild',   cls:'wild-btn',   label:"Offer to call a manager",
            text:"\"I can get you my manager on the phone right now.\"",
            moodDelta:-5, statHint:{charm:+1},
            nextLine:"Who is your manager." },
        ]},
      { customerLine:"I'm looking at the Corolla. However, I'd like to know why it's priced at $1,200 when I could get a newer one elsewhere. I've done my research.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Validate her standards",
            text:"\"You clearly know what a good deal looks like, which is exactly why I think the Corolla works for you specifically.\"",
            moodDelta:+12, statHint:{charm:+4},
            nextLine:"Go on." },
          { tag:'honest', cls:'honest-btn', label:"Explain the pricing plainly",
            text:"\"Because it's 30 years old with high miles. But Corollas are built to run forever. A newer car at this price would be riskier.\"",
            moodDelta:+15, statHint:{honesty:+5},
            nextLine:"...That's actually a fair point. I still have concerns." },
          { tag:'hustle', cls:'hustle-btn', label:"Offer a comparison test drive",
            text:"\"Go get the newer one. Drive it here. We'll compare on the spot. I'm confident.\"",
            moodDelta:+8, statHint:{closing:+3},
            nextLine:"I might actually do that. That's a bold offer. You'd better be right." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask to see her research",
            text:"\"What other car, specifically? Let's look at it together right now.\"",
            moodDelta:-8, statHint:{honesty:+2},
            nextLine:"I... it was a Facebook listing. It might be gone. That's not the point." },
        ]},
      { customerLine:"Fine. I'll consider the Corolla. But I want a warranty, I want it cleaned, and I want you to personally guarantee nothing will go wrong with it in the next year.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Give her the personal guarantee",
            text:"\"I personally guarantee that if something goes wrong, you call me first and I will figure it out. That's my word.\"",
            moodDelta:+20, statHint:{charm:+5}, outcome:'sold', commission:360,
            nextLine:"...Alright. That's the first reasonable thing anyone's said to me all week. Fine. $1,200." },
          { tag:'honest', cls:'honest-btn', label:"Be clear about what you can promise",
            text:"\"I can't guarantee a year — no one can honestly. But I'll clean it, and I'll take your call if something breaks in the first month.\"",
            moodDelta:+12, statHint:{honesty:+6}, outcome:'sold', commission:360,
            nextLine:"The first month is actually legally significant in most states. I looked it up. Fine." },
          { tag:'hustle', cls:'hustle-btn', label:"Create a fake warranty document",
            text:"\"We have a lot protection certificate. I'll write one up.\"",
            moodDelta:-15, statHint:{closing:+2,honesty:-5}, outcome:'blowup', commission:0,
            nextLine:"I want to see it. Right now. [reads it] This is a sticky note. This says 'Lot Guarantee' in ballpoint pen. I'm calling someone." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask what went wrong last time",
            text:"\"Something happened before this, didn't it. Tell me. I want to know.\"",
            moodDelta:+15, statHint:{charm:+4,honesty:+3}, outcome:'lowball', commission:200,
            nextLine:"...[long pause] The last one had a cracked block. I want your cell number and $200 off. Non-negotiable." },
        ]},
    ]
  },
  ...
  // 8 ── RETIREE
  {
    ...
    intro:"Earl arrives ten minutes before you open and has been walking the lot slowly since then. He knows more about these cars than you do. He's in no hurry. He has nowhere else to be.",
    rounds:[
      { customerLine:"I had a '78 Corolla. Drove it 240,000 miles. Gave it to my nephew. He drove it another 80,000 before the transmission went. Good cars, Corollas.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Invite the story",
            ...
            moodDelta:+20, statHint:{charm:+5},
            nextLine:"Ha. He did. He's a good kid. Doesn't know how to check oil but a good kid." },
          { tag:'honest', cls:'honest-btn', label:"Affirm the Corolla reputation",
            text:"\"That's the thing about Corollas — they outlast the reason you bought them. This '94 is the same DNA.\"",
            moodDelta:+18, statHint:{honesty:+5},
            nextLine:"What's the mileage on this one?" },
          { tag:'hustle', cls:'hustle-btn', label:"Steer toward the Silverado",
            text:"\"We also have a 2003 Silverado if you ever want something with more room.\"",
            moodDelta:-5, statHint:{closing:+2},
            nextLine:"I don't need room. I need reliable. I'm 71. I'm done needing room." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask about the nephew",
            text:"\"Is the nephew still driving it?\"",
            moodDelta:+12, statHint:{charm:+4},
            nextLine:"No, he bought something German. He'll regret it. They all regret it eventually." },
        ]},
      { customerLine:"The '94 Corolla. How many miles. Be straight with me — I can tell when a person's being straight.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Compliment his instincts",
            text:"\"I can tell. High miles — but they're highway miles, which matters. This engine has got plenty left.\"",
            moodDelta:+15, statHint:{charm:+4},
          ...
          { tag:'honest', cls:'honest-btn', label:"Give him the exact number",
            text:"\"178,000. Highway majority. Paint's tired but the drivetrain is solid — these run to 250,000 with basic maintenance.\"",
            moodDelta:+25, statHint:{honesty:+7},
            nextLine:"178. That's not too bad. You're not lying to me about the highway miles?" },
          { tag:'hustle', cls:'hustle-btn', label:"Soften the number",
            text:"\"They're high, but for a Corolla it's almost nothing. Think of it as broken-in.\"",
            moodDelta:-5, statHint:{closing:+2,honesty:-3},
            nextLine:"I asked you to be straight with me. How many miles. The number." },
          { tag:'wild',   cls:'wild-btn',   label:"Let him inspect it himself",
      ...
      { customerLine:"$1,200 seems high for the miles. I'm thinking $900. And I'm not in a rush. I'll come back.",
        choices:[
          { tag:'charm',  cls:'charm-btn',  label:"Enjoy the negotiation",
            text:"\"Earl, I've been waiting for someone who actually knows how to negotiate. $1,050. Let's shake on it.\"",
            moodDelta:+18, statHint:{charm:+5}, outcome:'lowball', commission:225,
            nextLine:"$975. I've been negotiating since before you were born. Flattery costs you $75." },
          { tag:'honest', cls:'honest-btn', label:"Split it plainly",
            text:"\"$1,050, split the difference. You know the car is worth it. I know you know.\"",
            moodDelta:+20, statHint:{honesty:+6}, outcome:'sold', commission:315,
            nextLine:"Yep. $1,050. Cash okay? I don't trust cards." },
          { tag:'hustle', cls:'hustle-btn', label:"Call his bluff gently",
            text:"\"Come back Friday. It'll probably still be here. But not at $1,200 — it'll be $1,350 by then.\"",
            moodDelta:-12, statHint:{closing:+2,honesty:-3}, outcome:'walkout', commission:0,
            nextLine:"Son, I've been buying cars since you were in diapers. I know a bluff. Good day." },
          { tag:'wild',   cls:'wild-btn',   label:"Ask about his wife",
            text:"\"You said your wife was right about most things. What would she say about this car?\"",
            moodDelta:+15, statHint:{charm:+6}, outcome:'lowball', commission:190,
            nextLine:"...She'd say buy it, but not at that price. She was careful with money. $900. That's for her." },
        ]},
    ]
  },
